\begin{figure}
  \begin{tikzpicture}[baseline=(current bounding box.center)]
    \begin{axis}[
      ...
      \addplot [color=red,mark=square*] table [x=n,y=naive] {naive-seminaive.dat};
      \addplot [color=blue,mark=*] table  [x=n,y=seminaive] {naive-seminaive.dat};
    \end{axis}
  \end{tikzpicture}
  \hfil
  {\small
