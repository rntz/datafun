...
In these examples, we make free use of strings and integers, ordered discretely
...
\item It is often convenient to treat $\prim{fix}$ as a binding form, $\efixis x
  e$, instead of explicitly supplying a function, $\efix\ebox{\fnof x e}$.
