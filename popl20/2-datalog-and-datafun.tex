...
chains,\footnote{\label{note:finite-eqtypes}As a technical detail, the finite
  set type $\tseteq{A}$ will possess infinite ascending chains if $\eqt A$ has
  ...
  with natural numbers $\N$, this would be an eqtype, but not a finite one.}
