...
Recall that our aim is to speed up $\efix f$ expressions using the derivative of
the function $f$ computes.
%
So you might expect us to use $\Deriv f$.
%%, the derivative of $f$.
%
However, $f$ is not a function~\citep{magritte}: it is an \emph{expression} that
computes a function, and $\Deriv f$ is the derivative of this \emph{expression}
--- it computes how $f$ changes. A derivative of a \emph{function}, on the other
