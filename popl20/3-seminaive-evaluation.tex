...
discretely, it permits no change at all: \todo{more explanation of why it's unit
  --- since things can't change, the only valid change is from $x$ to $x$, and
  there's no information necessary to tell us how to change}
