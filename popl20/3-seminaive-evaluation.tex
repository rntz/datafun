...
%
In this case, the derivative rule is simple: we only discover new paths at
...
\todo{Explain why computing $\name{step}'\<\name{dpath}_i$ isn't
  \naive/ever-increasing. Explain how this lets us compute $\name{path}_i$ more
...
%% TODO: introduce this parallel between step' and Δpath_{i+1} sooner?
