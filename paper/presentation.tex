...
\begin{frame}%{What's expressible this way?}
  ...
  \Large {What's expressible this way?}\vspace{0.5em}
  \large
  \begin{itemize}
...
\begin{frame}
  ...
  \item so that you can take fixed points
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \pause{\huge\[ \alt<3->{\ms{fix}\;\m{x}\;\ms{is}\;[...]}
