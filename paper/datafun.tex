...
Given sets $A$, $B$, posets $P$, $Q$, and usls $L$, $M$ we use the following
notation:
\begin{center}
  \begin{tabular}{cl}
...
We use $\boxplus$ and $\boxtimes$ for sum and product of sets to distinguish
them from sum and product of posets, which we will use more often

rather than the
more usual $+$ and $\times$ because we will more often be taking the sum and
product of posets.
