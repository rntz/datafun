...
\paragraph{Bounded fix-points} \TODO Discuss
datalog's constructor restriction (name?), not being sure how to encode it in a
type theory, its disadvantages, and the disadvantages of our approach ---
bounded fixed-points.

\TODO discuss ``finite equality types'' option which we discarded. bounded
fixpoints strictly more general, but at possible runtime cost, but finite types
