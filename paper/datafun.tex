...
different concrete syntax) by our prototype implementation.
...
consider:
\[\begin{array}{l}
\fname{compose} ~:~ \Set{A \x B} \mto \Set{B \x C} \mto \Set{A \x C}\\
\fname{compose}\;\m{x}\;\m{y} = \setfor{(a,c)}{(a,b) \in \m{x}, (b,c) \in \m{y}}
\end{array}\]
