...
%% \todo{To acknowledge:
%%   \begin{itemize}
%%   \item Chris Martens, for feedback
%%   \item Thanks to the anonymous ICFP reviewers for their comments,
%%   \item Kodowa/Eve (Chris Granger, Jamie Brandon) folks, for making me think
%%     about this?
%% \end{itemize}}
