...
\begin{figure*}
  ...
  \vspace{0.8em}\\
  \fux{\J{\GD}{\GG}{\fixle{\m{x}}{e_\top}{e}}{\eq{L}}}{
    \J{\GD}{\GG}{e_\top}{\eq{L}} &
    \J{\GD}{\GG,\m{x}\of \eq{L}}{e}{\eq{L}}}\dg
  &=& \TODO
  \end{array}\]
...
$f$, induction, and $x = f(x)$, we have $f^i(\unit) \le x$ for any $i \in \N$.
Thus $f^n(\unit) \le x$. Thus $f^n(\unit)$ is the least fixed point of $f$.
