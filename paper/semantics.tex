...
\begin{figure}
  ...
  \todo{If  we don't end up using the weird Set notation, remove it.}
...
\begin{figure*}
  ...
  \todo{NEED SEMANTICS OF TRUE, FALSE, IF, $\rt{IF}^+$}
...
\todo{figure defining substitution}

We have proven the following theorems:

\paragraph{Weakening and exchange}
...
\paragraph{Substitution, ordinary}
From
\begin{itemize}
...
\paragraph{Substitution, monotone}
From
\begin{itemize}
\item $\J{\GD}{\GG}{e_1}{A}$,
...
\todo{state semantic substitution theorem}
