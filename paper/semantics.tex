...
access to the comonad $\Disc{|A|}$, which lets us distinguish between
...
explicit coercions were somewhat noisy. However, the ghost of this
logic persists, as can be seen in the context-clearing actions in our
typing rules.
