...
constructors, pattern-matching\todo{(CITE)} (including non-linear patterns), and
additional syntax sugar given in Figure \ref{fig:sugar} \todo{(TODO: mention \&
  cite monadic query syntax)}. All of these conveniences are supported (with
...
set's element type support equality remains in force. \todo{CITE}
