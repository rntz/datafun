...
higher-order functions and Datalog doesn't. As a result, we hope to
first see if magic sets applies to first-order Datafun programs, and
then apply defunctionalization~\cite{defunctionalization} to extend it
to full Datafun.
