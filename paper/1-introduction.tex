...
\item Composite terms are forbidden; only ground terms and variables are
  ...
  \todo{actually, I think it's stronger: only \emph{atoms} and variables are
    permitted. But this doesn't seem necessary for the properties we discuss?
    I'm not sure why it was chosen. for simplicity, maybe?}
