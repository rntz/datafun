...
Our logical relations mimic our denotational semantics, with a slight twist. We
interpret types as sets of closed terms, but instead of equipping these sets
with partial orders, we equip them with preorders, since distinct closed
expressions may have equal denotations. To accomplish this, we inductively
define relations $\lr{A}{a \ale b}$ for each type $A$, then show how to
understand these relations as preordered sets.
...
\begin{proof}
  ...
  \url{https://github.com/rntz/datafun/}.
\end{proof}
