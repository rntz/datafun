...
% line spacings.
%
% Text font options are baskerville, charter, cochineal, fbb, libertine,
% palatino, pt. Math font options are euler and newmath. Default is charter
% with euler.
\usepackage{rntzfont}

% Some small typographic improvements.
\usepackage[T1]{fontenc}
\usepackage[spacing,tracking,letterspace=30]{microtype}
\frenchspacing
