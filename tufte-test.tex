...
%% Remove margin space to make it more readable on screens.
...
bivariance they have constancy, a stricter condition.\marginnote{Indiscreteness
  and its dual, discreteness, are also tones --- that is, functorial
  transformations on the ordering component of a preorder --- but they
  complicate things, so I omit them.
...
%
Constancy corresponds to respecting the \emph{indiscrete ordering} (which sets $a \le b$
for all $a,b$).
%
