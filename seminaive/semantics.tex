...
\renewcommand\qed{\vspace{.5\baselineskip}\hrule\vspace{.5\baselineskip}}         %FIXME hack.
...
\begin{proof}\label{proof:forget}
  ...
  \item[Case $x$] \( \vals{\incdens x} = \vals\pi_x = \pi_x = \den{x} \)

  \item[Case $\dvar x$] \( \vals{\incdens {\dvar x}}
