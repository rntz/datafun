...
\begin{figure*}
  \begin{mathpar}
    ...
    \end{array}
    \\
    \stripcx\G = (\hd x A)_{\hd x A \in \G}
    \\
...
%% TODO: check this proof works out!
\begin{align*}
...
\todo{TODO: Read off the incrementalization transform from the \emph{other}
  projection down to \Poset{}. Wait, but this involves monotonicity! Argh! To do
  this we need to fix our non-constructive use of $\zero$, which we do via
  $\fname{dummy} : A \to \chgs A$.}

%% TODO: unify with \desugars
