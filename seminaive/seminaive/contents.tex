...
\noindent
\todo{TODO: show $\deriv\pi_i$ correct.}
...
\noindent
\todo{TODO: explain why fork is unique s.t. $\fork{f_i}_i \then \pi_j = f_j$ ---
  is this inherited from \Poset, or does requiring differentiability make a
  difference?}
