...
\pagestyle{plain}
%\acmConference{HOPE}{2018}{St. Louis, Missouri}

%% \usepackage[scaled=1.023]{cochineal}
\usepackage[scaled=1.05]{cochineal}\linespread{1.03}
...
%% TODO FIXME XXX: citation for seminaive evaluation!
