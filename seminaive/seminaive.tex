...
%\usepackage[sc]{mathpazo}\linespread{1.13}
...
however, the definitions of these operators \emph{are not well-typed Datafun
  terms}. \todo{I do not believe there exists a way to assign them tones that is
  compatible with Datafun's type system; every way I've tried fails. But I have
  not proved this.}
...
\begin{gather}
x = x \oplus \zero\; x\\
x \le y \implies y = x \oplus (y \ominus x)
\end{gather}
...
%% \[\begin{array}{crcll}
%%   & a \oplus da &=& (a \oplus da) \oplus \zero \;(a \oplus da)
%%   & \text{\cref{lemma:zero-id}}\\
%%   & f\;a \oplus df\;a\;da &=&
%%   f\;(a \oplus da) \oplus df \;(a \oplus da) \;(\zero \;(a \oplus da))
%%   & \text{our condition \& antisymmetry}\\
%%   & f\;a \oplus df\;a\;da &=& (f \oplus df) \; (a \oplus da)
%%   & \text{definition of $\oplus_{A \to B}$}
%% \end{array}\]
