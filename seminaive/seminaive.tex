...
We can translate away uses of $\bigvee$ and $\mb{when}$ at non-decidable types by $\eta$-expansion:
...
\begin{array}{lcll}
  ...
  &=& \mb{case}~ \pair{\splitsum{\preservedisc{e}}}{\delta e} ~\mb{of}\\
   ...
   && \quad \textit{--- The following cases are unreachable.}\\
  ...
  \qquad \textit{--- This is a crucial over-approximation.}\\
  \delta(\single{e}) &=& \unit\\
