...
\todo{Furthermore, if $e : A$ originally, then in the the $\delta$-context,
  $\disc{e} : \Disc{A}$ for free, since all the varaibles $e$ uses are now
  discrete. Can/do we take advantage of this?} {\color{green} Yes we do! See the
