...
\usepackage[a5paper,margin=1cm,bottom=1.75cm]{geometry}
...
\usepackage{textcase,titlesec}

\titlespacing*{\section}{0pt}{0.75\baselineskip}{.5em}
\titlespacing*{\subsection}{0pt}{0.75\baselineskip}{.33em}

% \titleformat{\section}{format}{label}{sep}{before}[after]
\titleformat{\section}%
  {\normalsize\sffamily\bfseries}% format applied to label+text
  {\llap{\parbox{1cm}{\hfill\thesection}\hspace*{0.3cm}}}% label
  {0pt}% horizontal separation between label and title body
  {\MakeTextUppercase}% before the title body
  []% after the title body

\titleformat{\section}%
  {\large\itshape\sffamily}% format applied to label+text
  {\llap{\parbox{1cm}{\hfill\thesection}\hspace*{0.3cm}}}% label
  {0pt}% horizontal separation between label and title body
...
%%   {\llap{\parbox{1cm}{\hfill\normalsize\sffamily\bfseries\thesubsection}\hspace*{0.25cm}}}
%%   {0pt}
%%   {}
...
%% \usepackage{titlesec}
%% \titleformat{\section}
%%   [block]{\large\sffamily\bfseries}{\thesection}{1em}{}
%% \titleformat{\subsection}
%%   [block]{\sffamily\bfseries}{\thesubsection}{1em}{}
...
and $b \le a$. Antisymmetry means $a \equiv b$ implies $a = b$. However,
under list containment, $[0,1] \equiv [1,0]$, but $[0,1] \ne [1,0]$.
...
%
I write $A^s$ for the preorder $A$ transformed by the tone $s$, defined in
Figure \ref{fig:tone-functors}.
...
\begin{figure*}[t]
  ...
  \caption{Tones as preorder transformations}
  \label{fig:tone-functors}
\end{figure*}
