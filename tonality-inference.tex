...
\todo{TODO: the rule for synthesizing projections is wrong; what if I'm
  projecting from $\Box (A \x B)$? I think I need to generalize the
  ``spine-like'' subtyping rule.}
...
\begin{mathpar}
  ...
  \infer{\infers{\GG}{N}{A_1 \x A_2}}
        {\infers{\GG}{\pi_i\;N}{A_i}}
