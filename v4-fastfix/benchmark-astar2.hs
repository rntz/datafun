...
astar2_semi_simple = (let (sym_0, dsym_0) = ((\cbox_1 -> (let (c_2, dc_2) = cbox_1 in (\sbox_3 -> (let (s_4, ds_4) = sbox_3 in (\ibox_5 -> (let (i_6, di_6) = ibox_5 in (forIn s_4 (\pair_7 -> (guard (i_6 == (let (j_8, d_9) = pair_7 in j_8)) (guard (c_2 == (let (j_8, d_9) = pair_7 in d_9)) (set [(i_6 + 1)]))))))))))), (\cbox_1 -> (\dcbox_1 -> (let (c_2, dc_2) = cbox_1 in (\sbox_3 -> (\dsbox_3 -> (let (s_4, ds_4) = sbox_3 in (\ibox_5 -> (\dibox_5 -> (let (i_6, di_6) = ibox_5 in (forIn ds_4 (\pair_7 -> (guard (i_6 == (let (j_8, d_9) = pair_7 in j_8)) (guard (c_2 == (let (j_8, d_9) = pair_7 in d_9)) (set [(i_6 + 1)]))))))))))))))) in (let star_10 = (\rbox_11 -> (let (r_12, dr_12) = rbox_11 in (\sbox_3 -> (let (s_4, ds_4) = sbox_3 in (\ibox_5 -> (let (i_6, di_6) = ibox_5 in (semifix ((\self_13 -> (union (set [i_6]) (forIn self_13 (\j_8 -> ((r_12 (s_4, ds_4)) (j_8, dj_8)))))), (\self_13 -> (\dself_13 -> (union (forIn dself_13 (\j_8 -> ((r_12 (s_4, ds_4)) (j_8, dj_8)))) (forIn (union self_13 dself_13) (\j_8 -> ((((dr_12 (s_4, ds_4)) ()) (j_8, dj_8)) ())))))))))))))) in (star_10 ((sym_0 (97, 0)), ((dsym_0 (97, 0)) ())))))
astar2_semi_raw = (let (sym_0, dsym_0) = ((\cbox_1 -> (let (c_2, dc_2) = cbox_1 in (\sbox_3 -> (let (s_4, ds_4) = sbox_3 in (\ibox_5 -> (let (i_6, di_6) = ibox_5 in (forIn s_4 (\pair_7 -> (guard (i_6 == (let (j_8, d_9) = pair_7 in j_8)) (guard (c_2 == (let (j_8, d_9) = pair_7 in d_9)) (set [(i_6 + 1)]))))))))))), (\cbox_1 -> (\dcbox_1 -> (let (c_2, dc_2) = cbox_1 in (\sbox_3 -> (\dsbox_3 -> (let (s_4, ds_4) = sbox_3 in (\ibox_5 -> (\dibox_5 -> (let (i_6, di_6) = ibox_5 in (union (forIn ds_4 (\pair_7 -> (guard (i_6 == (let (j_8, d_9) = pair_7 in j_8)) (guard (c_2 == (let (j_8, d_9) = pair_7 in d_9)) (set [(i_6 + 1)]))))) (forIn (union s_4 ds_4) (\pair_7 -> (if (i_6 == (let (j_8, d_9) = pair_7 in j_8)) then (if (c_2 == (let (j_8, d_9) = pair_7 in d_9)) then Data.Set.empty else (guard False (union (set [(i_6 + 1)]) Data.Set.empty))) else (guard False (union (guard (c_2 == (let (j_8, d_9) = pair_7 in d_9)) (set [(i_6 + 1)])) (if (c_2 == (let (j_8, d_9) = pair_7 in d_9)) then Data.Set.empty else (guard False (union (set [(i_6 + 1)]) Data.Set.empty))))))))))))))))))) in (let star_10 = (\rbox_11 -> (let (r_12, dr_12) = rbox_11 in (\sbox_3 -> (let (s_4, ds_4) = sbox_3 in (\ibox_5 -> (let (i_6, di_6) = ibox_5 in (semifix ((\self_13 -> (union (set [i_6]) (forIn self_13 (\j_8 -> ((r_12 (s_4, ds_4)) (j_8, dj_8)))))), (\self_13 -> (\dself_13 -> (union Data.Set.empty (union (forIn dself_13 (\j_8 -> ((r_12 (s_4, ds_4)) (j_8, dj_8)))) (forIn (union self_13 dself_13) (\j_8 -> ((((dr_12 (s_4, ds_4)) ()) (j_8, dj_8)) ()))))))))))))))) in (star_10 ((sym_0 (97, 0)), ((dsym_0 (97, 0)) ())))))
