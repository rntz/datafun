...
%% %\usepackage[b5]{rntzgeometry}\usepackage[width=365pt,fullwidth=16cm]{narrow}
%% \usepackage[a5]{rntzgeometry}\usepackage[fullwidth=13cm,width=115mm]{narrow}
%% \usepackage{rntzfont}
%% %\linespread{1.1526}
...
%% Preorders have a natural ``subpreordering'' relationship, $A \subtype
%% B$, which in turn induces an ordering on tones:

%% \newcommand\defeq{\triangleq}

%% \[\def\arraystretch{1.2}\begin{array}{rcl}
%%   A \subtype B &\defeq&
%%   A \subseteq B \mathrel{\text{and}}
%%   (x \le y : A \implies x \le y : B)\\
%%   T \le U &\defeq& (\forall A)~ TA \subtype UA
%% \end{array}\]
