...
%% addition and $\tc$ as multiplication. Multiplication has $\tm$ as identity,
%% but lacks an absorbing zero element. (\todo{TODO: Reference ``I Got Plenty o'
%% Nuttin'{}'' --- another use of variable annotations drawn from a semiring,
%% and with similar (the same?) behavior of those annotations in the inference
%% rules.}) \Cref{fig:tone-op-laws} gives the relevant laws.
