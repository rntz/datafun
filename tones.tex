...
\usepackage[spacing=true,stretch=15,tracking=true,letterspace=30]{microtype}
\frenchspacing
...
\begin{mathpar}
  \begin{array}{rcclr}
    ...
    \text{contexts} & \G
    &\bnfeq& \emptycx \pipe \extend{\G}{\h{x}{T}{A}}\vspace{1pt}\\
    \text{judgments} & J
...
\todo{TODO: explain my various abuses of notation, e.g. $\mcx{T}{\G}$ and
  $\G_1 \tmeet \G_2$}
