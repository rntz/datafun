...
\usepackage[width=365pt,fullwidth=16cm,width=13cm,fullwidth=150mm]{narrow}
\usepackage[linespread=1.16667]{rntzfont}

%% \usepackage[a5]{rntzgeometry}
%% \usepackage[fullwidth=13cm,width=115mm]{narrow}
%% \usepackage[linespread=1.12,scaled=.9804]{rntzfont}
...
%% \makeatletter \noindent
%% before section: \rntz@secbefore\\
%% after section: \rntz@secafter\\
